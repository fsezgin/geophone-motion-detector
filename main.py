    ...
    try:
        ...
        if timer == 3:
            ...
            if count >= 9: # sequence_length(3) x data write time(timer = 3)
                predictions_inverse = predict_from_csv(model, r"C:\Users\furka\Desktop\ain4311\project\real-time-motion-detector\data\processed_data.csv", sequence_length=3)
